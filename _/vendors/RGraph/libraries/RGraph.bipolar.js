    ...
    RGraph.Bipolar = function (conf)
    {
        ...
        this.drawLabels = function ()
        {
            ...
            for (var i=0,len=labels.length; i<len; ++i) {
                RGraph.text({
                    ...
                    x:      this.marginLeft + this.axisWidth + (properties.marginCenter / 2),
                    ...
                    for (var i=0; i<this.scale2.labels.length; ++i) {
                        ...
                        if (properties.leftVisible) {
                            RGraph.text({
                                ...
                                y:      this.canvas.height - this.marginBottom + 7,
                        ...
                        if (properties.rightVisible) {
                            RGraph.text({
                                ...
                                x:      this.marginLeft+ grapharea + properties.marginCenter + ((grapharea / this.scale2.labels.length) * (i + 1)),
                                y:      this.canvas.height - this.marginBottom + 7,
            ...
            for (i=0,seq=0; i<coordsRight.length; ++i,++seq) {
                ...
                if (typeof this.right[i] === 'number') {
                    ...
                    RGraph.text({
                        ...
                        x:          coords[0] + coords[2] + 5 + (properties.variant === '3d' ? 10 : 0),
                        y:          coords[1] + (coords[3] / 2) + (properties.variant === '3d' ? -5 : 0),
        ...
        this.positionTooltipStatic = function (args)
        {
            ...
            if (properties.variant === '3d') {
                ...
                args.tooltip.style.top = parseInt(args.tooltip.style.top) + adjustment - 25 + 'px';
            }
