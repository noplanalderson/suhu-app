        ...
        this.drawLabelsAbove = function ()
        {
            ...
            for (var i=0; i<this.data.length + (properties.total ? 1 : 0); ++i) {
               ...
               italic: textConf.italic,
                    ...
                    x:      coords[0] + (coords[2] / 2) + properties.labelsAboveOffsetx,
                    y:      (isTotal ? this.total : this.data[i]) >= 0 ? (coords[1] - 3 - properties.labelsAboveOffsety) : (coords[1] + coords[3] + 3 + properties.labelsAboveOffsety),
                    text:   str,
